...
- `backgrounds/` — 4 curated 1-bit dithered wallpapers:
  - `1.jpg` — *The Tall Ship* (1807 merchant vessel on open dithered seas)
  - `2.jpg` — *The Coastal Lighthouse* (Stone beacon projecting light over stormy waters)
  - `3.jpg` — *The Mountain Pine Forest* (1984 Mac landscape of mountain peaks and lake)
  - `4.jpg` — *The Celestial Navigation Chart* (Antique 1864 astrolabe, compass rose, and star map)
...
### Cycle Wallpapers
Cycle through the 4 included 1-bit dithered backgrounds:
```bash
